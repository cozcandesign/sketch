...
export type Orderflow = components['schemas']['OrderflowOut']
export type OrderflowPoint = components['schemas']['OrderflowPointOut']
export type LiquidationRow = components['schemas']['LiquidationOut']
export type Funding = components['schemas']['FundingOut']
export type OpenInterest = components['schemas']['OpenInterestOut']
export type LongShort = components['schemas']['LongShortOut']
